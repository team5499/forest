class RawVarEditor extends React.Component {
    ...
    render() {
        return ([
            <WidgetContainer key={this.props.id + '_main'} title={this.props.title} width={this.props.width} height={this.props.height} id={this.props.id} noResize={this.props.noResize}>
